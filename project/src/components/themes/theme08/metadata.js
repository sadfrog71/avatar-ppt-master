  ...
  },
  {
    ...
    "controls": [
      ...
      },
      {
        ...
        "label": "每层标签数",
        "desc": "每个产业链层展示的标签数量(1–3)",
        "publicKey": "itemCount",
        "publicLabel": "每层标签数",
        "description": "每个产业链层展示的标签数量(1–3)"
      },
      {
        "key": "showRegion",
        "type": "boolean",
  ...
  },
  {
    ...
    "controls": [
      ...
      },
      {
        ...
        "showIf": "showItems",
        "label": "每象限标签数",
        "desc": "每个象限展示的代表项数量(1–3)",
        "publicKey": "itemCount",
        "publicLabel": "每象限标签数",
        "description": "每个象限展示的代表项数量(1–3)"
      },
      {
        "key": "showAxisLabels",
        "type": "boolean",
