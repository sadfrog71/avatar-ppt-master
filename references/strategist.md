...
### d2. Deck Type & Visual Strategy Confirmation (v1.2)

Determines the visual resource allocation strategy. This decision is **orthogonal to** Style Objective (d) — a Top Consulting deck can be either Analysis or Vision type.

| Deck Type | Visual Strategy | Image Budget | Primary Elements | When to Use |
|-----------|----------------|--------------|------------------|-------------|
| **Analysis** | Data-first, zero AI imagery | 0 (cover optional) | Charts, tables, badges, timelines, native SVG shapes | Data reports, diagnostics, operational reviews |
| **Vision** | Story-first, high AI imagery | 5-15 images | Hero images, concept illustrations, section dividers | Brand launches, vision decks, keynote speeches |
| **Training** | Diagram-first, low imagery | 1-3 images | Flowcharts, process diagrams, icon-heavy layouts | Training materials, SOP guides |
| **Marketing** | Conversion-first, medium imagery | 3-8 images | Product screenshots, customer testimonials, CTAs | Sales decks, pitch decks, landing page companions |

**Default rule**: If user does not specify, default to **Analysis** for content-heavy source documents; default to **Vision** for brief creative briefs.

**Hard rules**:
- Analysis decks: Skip AI image generation entirely (Step 5). Use native charts, tables, and geometric shapes for all visual needs.
- Vision decks: Follow full Image_Generator workflow (Step 5) with AI-generated hero images and concept art.
- Analysis deck cover: Use large color blocks + typography instead of AI-generated hero images.
