...
(function () {
  ...
  PulseExCover1.defaults = { ...(PulseExCover1.defaults || {}), copy: {
  "brand": "智造",
  "brandEn": "SMARTWORKS",
  "meta": [
    "INDUSTRY 4.0",
...
const Component = window.PulseExCover1;
if (!Component) throw new Error('Missing theme05 component PulseExCover1');
