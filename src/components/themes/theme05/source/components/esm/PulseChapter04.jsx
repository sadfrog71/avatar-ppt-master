...
/* =========================================================================
   ...
   To migrate into a bundler: delete the `window.PulseChapter04 = …` line and
...
(function () {
  ...
  if (typeof window !== "undefined") PulseChapter04.copyDefaults = COPY;
  PulseChapter04.defaults = { ...(PulseChapter04.defaults || {}), copy: COPY };
  window.PulseChapter04 = PulseChapter04;
})();

const Component = window.PulseChapter04;
if (!Component) throw new Error('Missing theme05 component PulseChapter04');
