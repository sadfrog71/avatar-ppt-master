...
(function () {
  ...
  PulseExCover4.defaults = { ...(PulseExCover4.defaults || {}), copy: {
  "setup": "SETUP · RETAIL OPS",
  "cornerLeft": "门店运营培训",
  "cornerRight": "SHEET 04 / 04",
  "titleTop": "把握消费趋势",
...
const Component = window.PulseExCover4;
if (!Component) throw new Error('Missing theme05 component PulseExCover4');
