...
(function () {
  ...
  PulseExCover2.defaults = { ...(PulseExCover2.defaults || {}), copy: {
  "top": "PULSE® BRAND LAB · FULL-FUNNEL MARKETING",
  "number": "NO. 02",
  "caption": "2026 年度全平台品牌整合营销方案",
  "titleTop": "创意破圈",
...
const Component = window.PulseExCover2;
if (!Component) throw new Error('Missing theme05 component PulseExCover2');
