...
const REMOTE_PACKAGE_URL = 'https://raw.githubusercontent.com/sadfrog71/avatar-ppt-master/main/skills/avatar-ppt-master/project/package.json';
...
async function main() {
  ...
  process.stdout.write(
    `发现 Avatar PPT Master 新版本 ${remoteVersion}（当前 ${localVersion}）。建议更新：重新拉取 https://github.com/sadfrog71/avatar-ppt-master 后替换本地 avatar-ppt-master。\n`
  );
}
